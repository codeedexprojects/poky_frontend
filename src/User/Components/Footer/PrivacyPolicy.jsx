  ...
  return (
    <>
      <div className="py-10 px-6 md:px-20 lg:px-40">
        ...
        <h2 className="text-lg font-semibold mb-2">III. IS PERSONAL INFORMATION ABOUT ME SECURE?</h2>
        <p className="mb-4">
        ...
        <h2 className="text-lg font-semibold mb-2">IV. WHAT CHOICES DO I HAVE?</h2>
        <ul className="list-disc list-inside mb-4">
          <li>You can always elect not to disclose information to us. However, please keep in mind that we may need some information to allow you register with us or to take advantage of some or all of our features, and if you choose not to provide that information, your ability to use our Website and services may be limited.</li>
          <li>You may be able to add, update, or delete information. When you update information, however, we may maintain a copy of the unrevised information in our records. You may request deletion of your account by visiting your account settings. Please note that some information may remain in our private records after your deletion of such information from your account. We may use any aggregated data derived from or incorporating your Personal Information even if you update or delete it, but we will not use that information in a manner that would identify you personally.</li>
          <li>If you do not wish to receive email or other mail from us, please change your account settings accordingly. Please note that if you do not want to receive legal notices from us, such as this Privacy Policy, those legal notices will still govern your use of the Website, and you are responsible for reviewing such legal notices for changes.</li>
        </ul>
        ...
        <p className="mb-4">
          If you have any questions or concerns regarding our privacy policies, please send us a detailed message to chimsuc@gmail.com. We will make every effort to resolve your concerns.
        </p>
      </div>
    </>
  );
