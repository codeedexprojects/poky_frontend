...
const FavouriteProduct = () => {
    ...
    return (
        <>
            <div className="bg-white h-[calc(100vh-4rem)] pb-20 overflow-y-auto p-4 xl:p-16 space-y-8">
                ...
                {wishlist.length > 0 && (
                    <p onClick={handleWishlistClear} className="text-sm underline underline-offset-1 hover:text-black cursor-pointer flex justify-end items-center">
                        Clear all
                    </p>
                )}
                ...
                {isLoading ? (
                    ...
                    <div className="flex flex-col justify-center items-center mt-0 mb-20">
                        ...
                        <div className="space-y-3 flex flex-col justify-center items-center">
                            ...
                            <Link to="/">
                                <Button className="bg-black text-sm capitalize w-48">Go Shopping</Button>
                            </Link>
                        </div>
                    </div>
                ) : (
                            ...
                            product.productId && (
                                <div key={product?.productId?._id} className="relative">
                                    ...
                                    <div className="mt-3">
                                        ...
                                        <p className="text-black-200 text-xs xl:text-sm truncate w-40 xl:w-60">
