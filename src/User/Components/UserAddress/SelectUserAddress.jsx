        ...
        <>
            ...
            <div className="p-4 xl:py-16 xl:px-32 lg:py-16 lg:px-32 bg-white h-[calc(100vh-4rem)] pb-20 overflow-y-auto">
                ...
                <div className='mt-5 flex flex-col xl:flex-row lg:flex-row gap-2 justify-normal xl:justify-center xl:items-center'>
                    <Link to='/add-delivery-address'><Button variant='outlined' className='w-full xl:w-52 lg:w-52 border-black text-black text-sm capitalize font-custom 
                    font-normal flex items-center gap-2 justify-center'><GoPlus />Add new address</Button></Link>
                    <Button onClick={handleContinue} className='w-full xl:w-52 lg:w-52 bg-black text-white text-sm capitalize font-custom 
