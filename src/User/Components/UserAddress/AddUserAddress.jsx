                                ...
                                <div className="flex flex-wrap gap-2 sm:gap-3">
                                    <Button 
                                        ...
                                        className={`text-black border-black font-custom text-xs sm:text-sm capitalize min-w-[70px] 
                                            ${addressType === "home" ? "text-black/50 border-black/50 text-opacity-100 shadow-none" : ""}`}
                                    >
                                        Home
                                    </Button>
                                    <Button 
                                        ...
                                        size="sm"
                                        className={`text-black border-black font-custom text-xs sm:text-sm capitalize min-w-[70px] 
                                            ${addressType === "work" ? "text-black/50 border-black/50 text-opacity-100 shadow-none" : ""}`}
                                    >
                                        Work
                                    </Button>
                                    <Button 
                                        ...
                                        size="sm"
                                        className={`text-black border-black font-custom text-xs sm:text-sm capitalize min-w-[70px] 
                                            ${addressType === "other" ? "text-black/50 border-black/50 text-opacity-100 shadow-none" : ""}`}
                                    >
                                        Other
                                    </Button>
                                </div>
