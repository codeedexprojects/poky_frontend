...
const EditUserAddress = () => {
    ...
    return (
        <>
            ...
            <div className="p-2 sm:p-4 xl:py-16 xl:px-32 lg:py-16 lg:px-32 bg-white min-h-[calc(100vh-4rem)] pb-20 overflow-y-auto">
                    ...
                    <Card className='p-3 sm:p-5 w-full max-w-[600px] mx-auto'>
                        <form className="space-y-4 sm:space-y-5 mt-3" onSubmit={editAddressFormSubmit}>
                            ...
                            <div className='flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3'>
                                ...
                                <div className="flex flex-wrap gap-2 sm:gap-3">
                                    <Button 
                                        ...
                                        variant='outlined' 
                                        size="sm"
                                        className={`text-black border-black font-custom text-xs sm:text-sm capitalize min-w-[70px] 
                                            ${editAddressType === "home" ? "text-black/50 border-black/50 text-opacity-100 shadow-none" : ""}`}
                                    >
                                        Home
                                    </Button>
                                    <Button 
                                        ...
                                        size="sm"
                                        className={`text-black border-black font-custom text-xs sm:text-sm capitalize min-w-[70px] 
                                            ${editAddressType === "work" ? "text-black/50 border-black/50 text-opacity-100 shadow-none" : ""}`}
                                    >
                                        Work
                                    </Button>
                                    <Button 
                                        ...
                                        variant='outlined' 
                                        size="sm"
                                        className={`text-black border-balck font-custom text-xs sm:text-sm capitalize min-w-[70px] 
                                            ${editAddressType === "other" ? "text-black/50 border-black/50 text-opacity-100 shadow-none" : ""}`}
                                    >
                                        Other
                                    </Button>
                                </div>
                            ...
                            <div className='mt-6'>
                                <Button
                                    type='submit'
                                    className='bg-black font-custom text-sm capitalize w-full font-normal py-3'
