...
const CartItems = () => {
            ...
            <div className='flex flex-col justify-center items-center h-[60vh] !mb-20'>
                ...
                <div className='space-y-3 flex flex-col justify-center items-center'>
                    ...
                    <Button 
                        ...
                        className='bg-black w-52 text-sm capitalize font-custom font-normal'
                    >
                        Login Now
                    </Button>
                </div>
    ...
    return (
        <>
            {cartItems.length > 0 && (
                <p onClick={handleClearAll} className='capitalize underline underline-offset-1 flex justify-end items-center gap-1 text-sm hover:text-black cursor-pointer'>
                    clear all</p>
            )}
            ...
            {isLoading ? (
                ...
                <div className='flex flex-col justify-center items-center h-[60vh] !mb-20'>
                    ...
                    <div className='space-y-3 flex flex-col justify-center items-center'>
                        ...
                        <Link to='/'>
                            <Button className='bg-black w-52 text-sm capitalize font-custom font-normal'>Go shopping</Button>
                        </Link>
                    </div>
                </div>
            ) : (
                        ...
                        <div className='flex justify-between'>
                            ...
                            <div className='flex flex-col items-end justify-between'>
                                <RiDeleteBin5Line
                                    ...
                                    className="text-deleteBg cursor-pointer hover:text-black"
                                />
