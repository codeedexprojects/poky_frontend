            ...
            <Card className='p-4 xl:p-6 lg:p-6'>
                <div className='flex items-center justify-between mb-3'>
                    ...
                    <Link to='/select-delivery-address'>
                        <p className='flex items-center gap-1 text-black underline text-sm font-medium'>
                    ...
                    <>
                        {((!userId && !token) || (!selectedAddress && !defaultAddr)) ? (
                            <p className='text-sm text-gray-600 text-center my-5'>
                                {(!userId && !token) ? (
                                    <>
                                        <Link to='/login-user' className='text-black font-semibold'>
                                            Log in
                ...
                <Button
                    ...
                    className='w-full bg-black font-custom font-normal text-sm capitalize'
                >
                    Checkout
                </Button>
            </Card>
