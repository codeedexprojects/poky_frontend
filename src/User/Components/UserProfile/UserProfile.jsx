...
const UserProfile = () => {
  ...
  return (
    <>
      <div className="p-4 xl:p-16 lg:p-16 bg-white h-[calc(100vh-4rem)] pb-20 overflow-y-auto hide-scrollbar">
        {!token ? (
          <>
            <div className='flex justify-center items-center h-[50vh]'>
              <div className='flex flex-col justify-center items-center space-y-1'>
                ...
                <Link to='/login-user'>
                  <p className='uppercase xl:text-4xl lg:text-4xl underline underline-offset-8 text-black'>create an account</p>
                </Link>
              </div>
            </div>
          </>
