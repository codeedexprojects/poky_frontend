            ...
            <div className='flex flex-col justify-center items-center space-y-5 mt-10'>
                {userCoupon ? (
                    <>
                        ...
                        <p className='text-3xl xl:text-4xl lg:text-4xl tracking-widest font-thin text-black'>{userCoupon}</p>
                    </>
                ) : (
                    <>
                        <p onClick={createWalkinCoupon} className='underline cursor-pointer text-black'>Create walkin coupon</p>
