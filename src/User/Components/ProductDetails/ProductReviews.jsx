    ...
    <>
      <div className='flex items-end justify-between border-b-2 pb-5 border-gray-300'>
        ...
        <Link to={!token && !userId ? '/login-user' : '/write-review'} state={{ productId }}>
          <Button className='bg-black font-normal capitalize font-custom py-2 px-4'>Add Review</Button>
        </Link>
      </div>
      ...
      <div className="mt-5">
        ...
        <Link to="/customer-reviews"
          ...
          <p className='text-black text-sm underline underline-offset-2 font-semibold'>
            View all reviews
          </p>
        </Link>
      </div>
