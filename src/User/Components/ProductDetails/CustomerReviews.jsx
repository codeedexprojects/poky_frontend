...
const CustomerReviews = () => {
    ...
    return (
        <>
            ...
            {/* Customer Reviews */}
            <div className="px-4 py-10 xl:py-16 xl:px-32 lg:py-16 lg:px-32 bg-white h-[calc(100vh-4rem)] pb-20 overflow-y-auto">
                ...
                <div className='hidden xl:flex lg:flex justify-center mt-10'>
                    <Link to='/write-review' state={{ productId }}>
                        <Button className='bg-black font-custom font-normal text-sm capitalize w-52'>
                            Write a Review
                        </Button>
                    </Link>
                </div>
                ...
                <div className="bg-white shadow-md fixed bottom-0 inset-x-0 flex justify-center z-50 p-4 lg:hidden xl:hidden md:hidden">
                    <Link to='/write-review' state={{ productId }} className='w-full'>
                        <Button className="bg-black font-custom font-normal text-sm capitalize w-full">
                            Write a Review
                        </Button>
                    </Link>
                </div>
