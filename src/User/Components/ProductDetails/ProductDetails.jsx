...
const ProductDetails = () => {
    ...
    return (
        <>
            <div className="p-4 xl:py-16 xl:px-32 lg:py-16 lg:px-32 bg-white h-[calc(100vh-4rem)] pb-20 overflow-y-auto">
                <div ref={topRef}>
          ...
          border-2 border-black ${selectedColor === color.color ? 'ring-2 ring-black' : ''}`} // <-- black border always
                                ...
                                <div className='mt-4'>
                                    <div className='flex items-center justify-between xl:justify-normal lg:justify-normal xl:gap-32 lg:gap-32 mb-2'>
                                        ...
                                        <h4 onClick={handleOpenSizeDrawer} className='text-black underline font-medium text-xs xl:text-sm lg:text-sm cursor-pointer'>Size chart</h4>
                                    </div>

                                    {/* Hint message */}
                                    {!selectedColor && (
                                        <p className="text-xs text-gray-500 mb-3">
                                            <span className='text-black'>*</span> Please select a color to see available sizes
                                        </p>
                                    )}
                                ...
                                <div className='mt-7 flex items-center gap-3'>
                                    <Button onClick={addToCart}
                                        className='hidden xl:flex lg:flex items-center justify-center gap-2 font-normal font-custom tracking-wide text-sm
                                            xl:text-base lg:text-base flex-1 bg-black border-[3px] border-black rounded-md hover:shadow-none'>
                                    ...
                                    {productDetails.isInWishlist || heartIcons[productDetails._id] ? (
                                        ...
                                        <Button
                                            ...
                                            className='hidden xl:flex lg:flex items-center justify-center gap-2 font-normal font-custom tracking-wide text-sm
                                                ...
                                                hover:shadow-none px-4'>
                                            <IoHeartOutline
                                                className='xl:text-3xl lg:text-3xl text-2xl text-black'
                                            />
                                        </Button>
                                    )}
                                ...
                                {totalReviews === 0 ? (
                                    <>
                                        <div className="mt-10">
                                            ...
                                            >
                                                <Button className="bg-black font-normal capitalize font-custom py-2 px-4">
                                                    Add Review
                                                </Button>
                                            </Link>
                                        </div>
                ...
                <div className="bg-white shadow-md fixed bottom-0 inset-x-0 z-50 w-full p-4 xl:hidden lg:hidden">
                    <div className="flex items-center gap-3">
                        ...
                        <Button
                            onClick={addToCart}
                            className='flex-1 flex items-center justify-center gap-2 font-normal rounded-md font-custom tracking-wide text-sm bg-black'
                        >
                            <RiHandbagLine />Add to cart
                        </Button>
        ...
        bg-transparent text-black border border-gray-500 px-3'
                            >
