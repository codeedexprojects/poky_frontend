...
const WriteReview = () => {
    ...
    return (
        <>
            ...
            <div className="p-4 xl:py-16 xl:px-72 lg:py-16 lg:px-72 bg-white h-[calc(100vh-4rem)] overflow-y-auto">
                <div className="grid grid-cols-1 gap-5">
                    {/* Image Upload Section */}
                    <div className='flex items-center justify-center'>
                        <div className="flex justify-center items-center w-full xl:w-96 lg:w-96 xl:h-72 lg:h-72 h-44 border-4 border-dashed border-black rounded-xl">
                            {!selectedImage ? (
                                <>
                                    <input
                                        type="file"
                ...
                <div className="hidden xl:flex lg:flex justify-center mt-10">
                    <Button type='submit' onClick={handleAddReview} className="bg-black font-custom font-normal text-sm capitalize w-52">
                        Submit Review
                    </Button>
                </div>

                <div className="bg-white shadow-md fixed bottom-0 inset-x-0 flex justify-center z-50 p-4 lg:hidden xl:hidden md:hidden">
                    <Button type='submit' onClick={handleAddReview} className="bg-black font-custom font-normal text-sm capitalize w-full">
                        Submit Review
                    </Button>
                </div>
            </div>
