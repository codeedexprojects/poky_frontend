        ...
        <Menu>
            <MenuHandler>
                ...
                >
                    Filter by size
                    {selectedSize && (
                        <span className="text-xs uppercase bg-black ml-5 px-2 text-white rounded-md">
                            {selectedSize}
                        </span>
                    )}
                ...
                {sizes.length > 0 ? (
                    sizes.map((size, index) => (
                        <MenuItem
                            ...
                            className="uppercase font-medium font-custom text-black cursor-pointer border-2 rounded-full w-28 h-10
