    ...
    return (
        <>
                                ...
                                <Card className='p-4 xl:p-6 lg:p-6'>
                                    <ul className='space-y-2'>
                                        ...
                                        {checkoutDetails?.coupenAmount ? (
                                            ...
                                            <li className='flex items-center justify-between'>
                                                <span className='text-secondary'>Coupon Discount</span>
                                                <span className='text-black font-normal text-xs'>No coupon applied</span>
                                            </li>
                                        )}
                                    ...
                                    <div className='flex justify-center'>
                                        <Button onClick={handleSubmitOrder} className='hidden w-56 xl:block lg:block mt-5 bg-black font-custom capitalize font-normal text-sm tracking-wider hover:bg-secondary'>Confirm Order</Button>
                                    </div>
                                    {/* </Link> */}
                                </Card>
                            </div>
            ...
            <div className='bg-white shadow-md fixed bottom-0 inset-x-0 z-50 w-full p-4 xl:hidden lg:hidden'>
                <Button onClick={handleSubmitOrder} className='w-full bg-black font-custom capitalize font-normal text-sm tracking-wider hover:bg-secondary'>Confirm Order</Button>
            </div>
