...
const Login = () => {
    ...
    return (
        <div className="relative h-screen w-full bg-cover bg-center bg-[url('/banner1.jpg')] bg-no-repeat">
            ...
            <div className="flex justify-center items-center h-full">
                <Card className="bg-white shadow-md p-10 cursor-default">
                    ...
                    <form className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96" onSubmit={handleSubmit}>
                        ...
                        <Button
                            type="submit"
                            className="mt-6 font-custom bg-black hover:bg-secondary text-sm font-normal capitalize tracking-wider"
                            fullWidth
                        >
                            Sign In
                        </Button>
