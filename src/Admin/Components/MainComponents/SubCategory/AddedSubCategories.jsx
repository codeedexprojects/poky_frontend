                                            ...
                                            <tr key={subCat?._id} className="bg-transparent">
                                                ...
                                                <td className={classes}>
                                                    <div className="flex justify-center gap-2 text-sm">
                                                        ...
                                                        <button onClick={() => { handleOpen("deleteModal"); setSelectedCatId(subCat._id); }} className="text-deleteBg bg-black/20 w-14 h-7 flex justify-center items-center rounded-md hover:bg-black hover:text-white">
                                                            Delete
                                                        </button>
                                                    </div>
                                                </td>
