         ...
         focus:outline-none placeholder:capitalize'/>
                ...
                <div className='bg-white rounded-xl shadow-md p-5 space-y-6 h-fit'>
                            ...
                            editProdImage.map((image, index) => (
                                <div key={index} className="w-32 h-32 relative">
                                    ...
                                    <MdDelete
                                        ...
                                        className="absolute top-0 right-0 text-deleteBg text-lg cursor-pointer hover:text-black"
                                    />
                                </div>
                            ))
                        ) : (
                    ...
                    <div className='flex gap-5'>
                        <div className="flex flex-col justify-center items-center w-72 h-56 border-4 border-dashed border-black rounded-xl">
                            <input
                                type="file"
                                id="file"
                                className="hidden"
                                ...
                                newImage.map((image, index) => {
                                    if (image instanceof File) {
                                        return (
                                            <li
                                                key={index}
                                                className="flex items-start justify-between bg-black/15 rounded-md p-2"
                                            >
                                                ...
                                                <MdDelete
                                                    ...
                                                    className="text-deleteBg text-lg cursor-pointer hover:text-black"
                                                />
                                            </li>
                                        );
                                    }
