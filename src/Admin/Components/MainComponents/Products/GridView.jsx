                                                    ...
                                                    <Menu>
                                                        <MenuHandler>
                                                            <IconButton variant="text" className='bg-white h-4 rounded-md hover:bg-white focus:bg-white'>
                                                                <HiOutlineDotsHorizontal className='text-black text-2xl cursor-pointer' />
                                                            </IconButton>
                                                        </MenuHandler>
                                                        <MenuList>
                                                            <MenuItem
                                                            ...
                                                            <MenuItem
                                                                ...
                                                                className='font-custom text-black hover:!text-black'
                                                            >
                                                                Delete</MenuItem>
                                                        </MenuList>
                                                    </Menu>
                                            ...
                                            <CardBody className='p-4'>
                                                <div className="mb-2 flex items-start justify-between">
                                                    <div>
                                                        ...
                                                        <Typography color="blue-gray" className="font-semibold font-custom text-black">
