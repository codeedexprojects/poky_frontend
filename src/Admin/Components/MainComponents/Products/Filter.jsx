        ...
        <div className='bg-white shadow-sm border-[1px] rounded-xl p-5'>
            <ul className='flex items-center justify-between gap-2'>
                <li
                    ...
                    className={`text-secondary text-base font-normal bg-gray-100 rounded-md flex items-center justify-center gap-1 py-2 w-full transition-all duration-300 ease-in-out cursor-pointer ${view === 'list' ? '!bg-black/30 py-2 px-2 rounded-md !text-black' : ""}`}
                >
                    <FaRegRectangleList /> List View
                </li>
                <li
                    onClick={() => setView("grid")}
                    className={`text-secondary text-base font-normal bg-gray-100 rounded-md flex items-center justify-center gap-1 py-2 w-full transition-all duration-300 ease-in-out cursor-pointer ${view === 'grid' ? '!bg-black/30 py-2 px-2 rounded-md !text-black' : ""}`}
                >
