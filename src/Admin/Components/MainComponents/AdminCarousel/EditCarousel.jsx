...
const EditCarousel = ({ initialEditCarouselData, setAdminCarousel }) => {
    ...
    return (
        <>
            <p onClick={() => navigate(-1)} className='flex items-center cursor-pointer hover:text-black mb-2'>
                    ...
                    <form action="" className='space-y-5' onSubmit={handleEditCarouselSubmit}>
                        ...
                        <div>
                            <div className='flex items-center justify-between'>
                                ...
                                <RiDeleteBin5Line onClick={() => setEditCarouselImage(null)} className='text-deleteBg text-xl hover:text-black cursor-pointer' />
                            </div>
